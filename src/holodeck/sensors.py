...
class DuckiebotsSemanticMaskCamera(HolodeckSensor):
    """Captures agent's view.
    ...
    **Configuration**
    ...
    def __init__(self, client, agent_name, agent_type, name="DuckiebotsSemanticMaskCamera", config=None):
        ...
        super(DuckiebotsSemanticMaskCamera, self).__init__(
            client, agent_name, agent_type, name=name, config=config
        )
...
class DuckiebotsLoopStatusSensor(HolodeckSensor):
...
class ProgressAlongIntendedPathSensor(HolodeckSensor):
...
class DuckiebotsVelocitySensor(HolodeckSensor):
...
class DuckiebotsLineOverlapSensor(HolodeckSensor):
...
class YawSensor(HolodeckSensor):
...
class SensorDefinition:
    ...
    _sensor_keys_ = {
        ...
        "DuckiebotsLoopStatusSensor": DuckiebotsLoopStatusSensor,
        "ProgressAlongIntendedPathSensor": ProgressAlongIntendedPathSensor,
        "DuckiebotsLineOverlapSensor": DuckiebotsLineOverlapSensor,
        "DuckiebotsVelocitySensor": DuckiebotsVelocitySensor,
        "DuckiebotsSemanticMaskCamera": DuckiebotsSemanticMaskCamera,
        "YawSensor": YawSensor
    }
